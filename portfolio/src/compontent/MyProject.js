      ...
      <div className='projects-flex1'>
        <div className='p1'>
          ...
          <a href='https://a.humanrightsfirst.dev/'>
            ...
            <img className='p1-image' variant="top" src={HRF} alt='human rights first website screenshot' />
            </a>
            <div className='p1-body' >
              ...
              <button className='p1-button1' href="https://a.humanrightsfirst.dev/" variant="primary">
                App
              </button>
              <button className='p1-button2' href="https://github.com/mrockingham/human-rights-first-be-a" variant="primary">
                Git
              </button>
              </div>
            </div>
        ...
        <div className='p1-card' >
          <a  href='https://clone-72250.firebaseapp.com/'>
            <img className='p1-image' alt='amazon clone screenshot'  variant="top" src={amazonClone}  />
            </a>
            <div className='p1-body' >
              ...
              <div className='p1-button-group'>
              <button className='p1-button1' variant="primary">
                App
              </button>
              <button className='p1-button2' href="https://github.com/mrockingham/Amazonclone" variant="primary">
                Git
              </button  > 
              </div>
            </div>
        ...
        <a href='https://conway-s-mike-s-game.vercel.app/'>
            <img className='p1-image' variant="top" src={conway} alt='Conways game of life screenshot' />
          </a>  
            <div className='p1-body' style={{paddingBottom: '5%'}}  >
              ...
              <div className='p1-button-group'>
              <button className='p1-button1' href='https://conway-s-mike-s-game.vercel.app/' >
                App
              </button>
              <button className='p1-button2'  href="https://github.com/mrockingham/Conway-s-mike-s-Game" variant="primary">
                Git
              </button>
              </div>
            </div>
        ...
        <a href='https://dadsapp.vercel.app/'>
            <img className='p1-image' alt='Dads app screenshot' variant="top" src={dad} />
            </a>
            <div className='p1-body 2' >
              ...
              <div className='p1-button-group'>
              <button className='p1-button1' >
                App
              </button>
              <button className='p1-button2' href="https://github.com/mrockingham/dadsapp" >
                Git
              </button>
              </div>
            </div>
